...
export function LanguageSwitcher({ targetLocale, label, accessibleLabel }: LanguageSwitcherProps) {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-10 items-center gap-2 rounded-full border border-caramel-400/40 bg-white/50 px-3 py-2 text-xs font-bold text-brown-700 transition-colors hover:bg-cream-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-caramel-500 disabled:cursor-wait disabled:opacity-60 min-[480px]:px-4"
    >
