  ...
  return (
    ...
    >
      <Container className="grid items-start px-0 sm:px-0 lg:grid-cols-[0.94fr_1.06fr] lg:px-12">
        <div className="hero-copy-shell flex items-center px-5 py-14 sm:px-8 sm:py-20 lg:sticky lg:top-20 lg:h-[calc(100svh-5rem)] lg:px-0 lg:pe-14 lg:py-8">
          <div className="max-w-3xl">
            ...
            <h1
              id="home-heading"
              className="hero-copy-title mt-7 text-[clamp(3.2rem,12vw,5.2rem)] font-black leading-[0.94] tracking-[-0.055em] text-brown-900 lg:text-[clamp(4.6rem,6.4vw,7.5rem)]"
            >
              {t("titleLead")}
            ...
            <p className="hero-copy-description mt-7 max-w-xl text-lg leading-8 text-brown-700 sm:text-xl sm:leading-9">
              {t("description")}
            </p>

            <div className="hero-copy-actions mt-9 flex flex-wrap gap-3">
              <a
                href="#menu"
            ...
            <a
              href="#introduction"
              className="hero-copy-scroll mt-11 inline-flex min-h-11 items-center gap-3 text-xs font-black uppercase tracking-[0.18em] text-brown-700 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-caramel-500"
            >
              {t("scroll")}
