...
const highlightKeys = ["fresh", "home", "moments"] as const;
  ...
  return (
    <div className="flex min-h-dvh flex-col overflow-hidden bg-cream-50">
      ...
      <main className="flex-1">
        <section className="relative isolate min-h-[calc(100dvh-5rem)] overflow-hidden border-b border-brown-900/10">
          ...
          <Container className="grid min-h-[calc(100dvh-5rem)] items-center gap-12 py-16 lg:grid-cols-[1.1fr_0.9fr] lg:py-24">
            <div className="max-w-3xl">
              ...
              <p className="mt-8 max-w-2xl text-lg leading-9 text-brown-700 sm:text-xl">{home("description")}</p>
              ...
              <div className="mt-10 flex flex-wrap items-center gap-4">
                ...
                <span className="text-sm font-semibold text-brown-700">{home("pagePreparing")}</span>
              </div>
            </div>
        ...
        <section id="about" className="scroll-mt-20 bg-white/45 py-16 sm:py-20" aria-labelledby="foundation-heading">
          <Container>
            <div className="max-w-2xl">
              <p className="text-sm font-black tracking-wider text-caramel-500">{home("storyEyebrow")}</p>
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              {highlightKeys.map((key, index) => (
                ...
                >
                  ...
                  <h3 className="mt-6 text-xl font-black text-brown-900">{home(`highlights.${key}.title`)}</h3>
                  <p className="mt-3 leading-8 text-brown-700">{home(`highlights.${key}.description`)}</p>
                </article>
              ))}
            </div>
          </Container>
